...
//        get upcoming events
    ...
    @GetMapping("/requestAndMonthlyGrowth/{mid}")
    public List<Double> getPendingRequestAndMonthlyGrowthOfArtist(@PathVariable int mid){
        ...
        List<Double> monthlyGrowthAndRequest= new ArrayList<>(2);
        monthlyGrowthAndRequest.add(0.0);
        monthlyGrowthAndRequest.add(0.0);
