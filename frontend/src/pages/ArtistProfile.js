    ...
    <>
      <SideMenuBarArtist>
            ...
            <div className="artist-details-in-dashboard">
              ...
              <div className="d-flex justify-content-between button-proofcheck">
                <button
                  ...
                  style={{
                    backgroundColor: "rgb(118, 67, 210)",
                    border: "none",
                    height: "40px",
                    width: "auto",
                  }}
                ...
                <button
                  ...
                  style={{ height: "40px", width: "auto", marginLeft: "10%" }}
                >
                  <h5>Cancel</h5>
                </button>
              </div>
        ...
        <Modal show={show} onHide={handleClose} animation={false}>
          <Modal.Header
            closeButton
            style={{ backgroundColor: "#24292D", color: "white" }}
          >
