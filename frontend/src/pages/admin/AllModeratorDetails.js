...
export default function AllModeratorDetails() {
    ...
    useEffect(() => {
      ...
      if (userId) {
          ...
          axios.get(`http://localhost:8080/moderator/view/verified`)
            .then(response => {
    ...
    return (
      ...
      <div className="adminProfile-backBtn">
        <button onClick={() => navigate('/admin/userdetails/moderators/add')}>+</button>
      </div>
