    ...
    <div className="artistSpecificEventDiv">
      <SideMenuBarArtist>
        ...
        <div className="countDown">
          ...
          <Countdown
            date={Date.now() + differenceInSeconds * 1000}
            renderer={renderer}
          ></Countdown>
        ...
        <div className="specificEventDate">
          ...
          <div className="specificDateDiv">
            <img
              className="specificdateImage"
              src={artistUpcommingCalandar}
              alt=""
            ></img>
          </div>
        ...
        <div className="specificEventLocation">
          <div style={{ height: "100vh", width: "100%" }}>
            <GoogleMapReact
              bootstrapURLKeys={{
                key: "AIzaSyDH-XDRV7DiBfOPlXaq6Oj6LPoDw9bthuo",
              }}
