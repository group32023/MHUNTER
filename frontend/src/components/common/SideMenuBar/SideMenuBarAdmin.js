            ...
            >
                <div className="menu-upper">
                    ...
                    <ul className={isExpanded ? "nav nav-pills flex-column px-0 mt-3" : "nav nav-pills flex-column px-0 mt-4"}>
                        ...
                        <li className={isExpanded ? "nav-item p-1" : "nav-item"}>
                            <NavLink to="/admin/dashboard" activeClassName="active" className={isExpanded ? "nav-link   d-flex align-items-center text-decoration-none" : "nav-link collapsed-nav-link   d-flex align-items-center text-decoration-none"}>
