      ...
      <div className='d-flex'>
        ...
        <div>
          <Routes>
            ...
            <Route path='/organizerDashboard' element={<EventOrganizerDashboard />} />
          </Routes>
        </div>
      </div>
    </BrowserRouter>
  ...
  return (
    <div className='content_container'>
      ...
      <h2>Web designers generally have nothing to do with creating content for their projects. Even so, the look of a site can be incomplete if no words are included. Web designers need to find ways to incorporate copyright-free content into their designs to provide clients with a look that is as finished as possible.
        ...
        Dummy text is also known as filler text or placeholder text, and it has been used for a long time in the various fields of online publishing.</h2>
    </div>
  );
}
